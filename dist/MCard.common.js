...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".shade-element[data-v-08838a1e]{background-color:rgba(0,0,0,.4);width:var(--ef58ad9c);height:var(--6852833b);margin:-5em 0 0 -3.5em;transform-origin:center;z-index:-1;border-radius:var(--5e77e21c)}.shade-blur[data-v-08838a1e]{filter:var(--00fc9b84)}.card-container[data-v-08838a1e],.face[data-v-08838a1e],.face-wrapper[data-v-08838a1e],.shade-element[data-v-08838a1e],.shape[data-v-08838a1e],.shape-body[data-v-08838a1e]{position:absolute;transform-style:preserve-3d}.shape[data-v-08838a1e]{width:0;height:0;transform-origin:center}.face[data-v-08838a1e],.face-wrapper[data-v-08838a1e]{overflow:hidden;transform-origin:0 0;backface-visibility:hidden}.face[data-v-08838a1e]{background-size:100% 100%!important;background-position:50%}.face-wrapper .face[data-v-08838a1e]{left:100%;width:100%;height:100%}.photon-shader[data-v-08838a1e]{position:absolute;left:0;top:0}.photon-shader[data-v-08838a1e],[class*=cuboid] .shape-body[data-v-08838a1e],[class*=cuboid] .shape-body .bk[data-v-08838a1e],[class*=cuboid] .shape-body .ft[data-v-08838a1e]{width:100%;height:100%}[class*=cuboid] .shape-body .bk[data-v-08838a1e]{left:100%}.cub-1[data-v-08838a1e]{transform:translateZ(0) rotateX(0deg) rotateY(0deg) rotate(0deg);opacity:1;width:var(--ef58ad9c);height:var(--6852833b);margin:-5em 0 0 -3.5em}.cub-1 .shape-body .face[data-v-08838a1e]{background-color:#fff}.cub-1 .shape-body .ft[data-v-08838a1e]{transform:translateZ(0);background-image:var(--c0201732);background-color:#a76c6c}.cub-1 .shape-body .bk[data-v-08838a1e],.cub-1 .shape-body .ft[data-v-08838a1e]{border-radius:var(--5e77e21c);width:var(--ef58ad9c)}.cub-1 .shape-body .bk[data-v-08838a1e]{transform:translateZ(0) rotateY(180deg);background-image:var(--69c621d1);background-color:#354b7e}.card-rotate[data-v-08838a1e]{transform:var(--b2e2ef98)}.shade-opacity[data-v-08838a1e]{opacity:var(--da6e3ad0)}.shade-rotate[data-v-08838a1e]{transform:var(--9a76534e)}.card-rotate-outside[data-v-08838a1e]{transform:var(--5891657b)}", ""]);
// Exports
...
// load the styles
var content = __webpack_require__(5561);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(7037)/* ["default"] */ .Z)
var update = add("30757906", content, true, {"sourceMap":false,"shadowMode":false});
      ...
      default:
        if (shapeFlag & 1 /* ShapeFlags.ELEMENT */) {
          ...
          if (isAsyncWrapper(vnode)) {
            let subTree;
            if (isFragmentStart) {
              subTree = runtime_core_esm_bundler_createVNode(Fragment);
...
function createStaticVNode(content, numberOfNodes) {
  ...
  const vnode = runtime_core_esm_bundler_createVNode(Static, null, content);
...
function normalizeVNode(child) {
  if (child == null || typeof child === 'boolean') {
    ...
    // fragment
    return runtime_core_esm_bundler_createVNode(Fragment, null,
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-41.use[2]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[4]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/MCard.vue?vue&type=template&id=08838a1e&scoped=true&ts=true

const _withScopeId = n => (_pushScopeId("data-v-08838a1e"), n = n(), _popScopeId(), n);
const _hoisted_1 = /*#__PURE__*/createStaticVNode("<div class=\"shape cuboid-1 cub-1 card-rotate-outside\" data-v-08838a1e><div class=\"shape-body card-rotate\" data-v-08838a1e><div class=\"face ft\" data-v-08838a1e><div class=\"photon-shader\" style=\"background-color:rgba(0, 0, 0, 0.15);\" data-v-08838a1e></div></div><div class=\"face bk\" data-v-08838a1e><div class=\"photon-shader\" style=\"background-color:rgba(0, 0, 0, 0.15);\" data-v-08838a1e></div></div></div></div><div class=\"shade-rotate shade-element shade-blur shade-opacity\" data-v-08838a1e></div>", 2);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    //@ts-ignore
    (...args) => _ctx.cardClickHandler && _ctx.cardClickHandler(...args))
  }, _hoisted_3);
}
;// CONCATENATED MODULE: ./src/components/MCard.vue?vue&type=template&id=08838a1e&scoped=true&ts=true

;// CONCATENATED MODULE: ./src/easing.ts
function easeInOutCubic(time, beginValue, change, duration) {
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-41.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/MCard.vue?vue&type=script&lang=ts


const __default__ = runtime_core_esm_bundler_defineComponent({
  name: 'MCard',
  props: {
  ...
  setup(props) {
    const MAX_Z_AXIS = 2;
    const D_TIME = 8;
    const isOpened = reactivity_esm_bundler_ref(props.initiallyOpened);
    const isMoving = reactivity_esm_bundler_ref(false);
    const rotateX = reactivity_esm_bundler_ref(0);
    const rotateY = reactivity_esm_bundler_ref(props.initiallyOpened ? 0 : 180);
    const rotateZ = reactivity_esm_bundler_ref(0);
    const zAxis = reactivity_esm_bundler_ref(0);
    ...
    const cardClickHandler = () => {
      if (isOpened.value) closeCard();else openCard();
    };
    return {
      cardClickHandler,
      ...
      rotation: runtime_core_esm_bundler_computed(() => `rotateX(${rotateX.value}deg) rotateY(${rotateY.value}deg)`),
      rotationOutsize: runtime_core_esm_bundler_computed(() => `translateZ(${zAxis.value * 50}px)`),
      rotationShade: runtime_core_esm_bundler_computed(() => `scaleX(${Math.round(Math.abs(Math.cos(rotateY.value * Math.PI / 180) * 100)) / 100})`),
      opacityShade: runtime_core_esm_bundler_computed(() => `${Math.max(0, Math.min(1, (10 - zAxis.value) / 10))}`),
      shadeBlur: runtime_core_esm_bundler_computed(() => zAxis.value > 0 ? `blur(${zAxis.value * 3}px)` : 'none'),
      calculatedWidth: runtime_core_esm_bundler_computed(() => `${props.width}${props.sizeMetric}`),
      calculatedHeight: runtime_core_esm_bundler_computed(() => `${props.height}${props.sizeMetric}`),
      calculatedBorderRadius: runtime_core_esm_bundler_computed(() => `${props.cornerRadius}${props.sizeMetric}`)
    };
  }
});
...
const __injectCSSVars__ = () => {
  useCssVars(_ctx => ({
    "ef58ad9c": _ctx.calculatedWidth,
    "6852833b": _ctx.calculatedHeight,
    "5e77e21c": _ctx.calculatedBorderRadius,
    "00fc9b84": _ctx.shadeBlur,
    "c0201732": _ctx.frontImageUrl,
    "69c621d1": _ctx.backImageUrl,
    "b2e2ef98": _ctx.rotation,
    "da6e3ad0": _ctx.opacityShade,
    "9a76534e": _ctx.rotationShade,
    "5891657b": _ctx.rotationOutsize
  }));
};
...
/* harmony default export */ var MCardvue_type_script_lang_ts = (__default__);
;// CONCATENATED MODULE: ./src/components/MCard.vue?vue&type=script&lang=ts
 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-22.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-22.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-22.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-22.use[3]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-22.use[4]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/MCard.vue?vue&type=style&index=0&id=08838a1e&scoped=true&lang=scss
var MCardvue_type_style_index_0_id_08838a1e_scoped_true_lang_scss = __webpack_require__(5307);
;// CONCATENATED MODULE: ./src/components/MCard.vue?vue&type=style&index=0&id=08838a1e&scoped=true&lang=scss

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(89);
;// CONCATENATED MODULE: ./src/components/MCard.vue
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(MCardvue_type_script_lang_ts, [['render',render],['__scopeId',"data-v-08838a1e"]])

/* harmony default export */ var MCard = (__exports__);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = (MCard);
...
/******/ })()
;
//# sourceMappingURL=MCard.common.js.map